...
<body>
            	...
            	<div class="general_content">
                	<div class="main_content">
                        ...
                        <div class="separator" style="height:30px;"></div>
                            <h3><a style="color:#227700;text-decoration:none;">查询酒店</a></h3>
                          <div class="block_popular_posts">
							
	<form name="searchForm" action="hoteldetailservlet?op=search2" method="post">
	...
	<table class="right-table" width="120%"  border="0px" cellpadding="0" align="center" cellspacing="0">
		...
		<tr>
			<td>目的城市</td>
			<td><input type="text"  name="city" value="${requestScope.hotelDetail.city }"/></td>
		</tr>
		<tr>
			<td>酒店名</td>
			<td><input type="text"  name="name" value="${requestScope.hotelDetail.name }"/></td>
		</tr>
		<tr>
			<td>星级</td>
			<td>
				<select name="typeId" id="typeId">
					...
					<c:forEach items="${requestScope.hotelTypeList }" var="hotelType">
						<option value="${hotelType.id }" ${hotelType.id==requestScope.hotelDetail.typeId?"selected='selected'":"" }>${hotelType.typeName }</option>	
					</c:forEach>
				</select>
			</td>
		</tr>
		<tr>
			<td>地址关键字</td>
			<td><input type="text" name="address" value="${requestScope.hotelDetail.address }"/></td>
		</tr>
		<%-- 
		<tr>
			<td>发布者</td>
		...
		<tr>
			<td colspan="2">
				<input type="submit" class="general_button" value="查询"/>
				<input type="reset" class="general_button" value="清空条件" />
			</td>
		</tr>
	</table>
                        ...
                        <h2><a style="color:#227700;text-decoration:none;">酒店信息</a></h2>
                    ...
                    <c:forEach items="${requestScope.hotelDetailList }"  var="hotelDetail" varStatus="status">
                        <article class="block_topic_post_feature">
                        	<div class="f_pic"><a href="hoteldetailservlet?op=toHotelDetailWeb&id=${hotelDetail.id }" class="general_pic_hover scale"><img src="http://localhost:8080/travelnews/${hotelDetail.imgUrl}" height="150" width="300"></a></div>
                            
                            <div class="content">
                            	<p class="title"><a href="hoteldetailservlet?op=toHotelDetailWeb&id=${hotelDetail.id }" target="_blank">${hotelDetail.name }</a></p>
                                
                                <div class="info">
                                	<div class="date"><p>${hotelDetail.city } ${hotelDetail.publishTime }</p></div>
                                 ...
                                 <p class="text"><a style="color:#227700;text-decoration:none;" href="hoteldetailservlet?op=toHotelDetailWeb&id=${hotelDetail.id }"><u>详情</u></a></p>
                            </div>
            ...
            <!--      分页功能部分        -->    
                        <div class="block_pager">
                        	<a style="color:#227700;text-decoration:none;" href="hoteldetailservlet?op=listWeb&pageNo=${sessionScope.pageBean.prePage }"> 上一页</a>
                           <a style="color:#227700;text-decoration:none;" href="hoteldetailservlet?op=listWeb&pageNo=${sessionScope.pageBean.nextPage }"> &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp下一页</a>
