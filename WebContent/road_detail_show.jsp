...
<base href="http://localhost:8080/travelnews/" />
...
<body>
                 ...
                 <section class="section_main_menu">                               	
                  ...
                  <ul>
								...
								<li class="big_dropdown" data-content="technology"><a href="newsdetailservlet?op=toNewsShow">旅游资讯</a></li>
							  	<li class="current_page_item" data-content="business"><a href="roaddetailservlet?op=listAll">旅游路线</a></li>
        	...
        	<div class="inner">
            	<div class="general_content">
                	<div class="main_content">
                        ...
                        <h2><a style="color:#227700;text-decoration:none;">旅游路线</a></h2>
                       ...
                       <article class="block_single_news">
                          ...
                          <p class="title"><a style="text-decoration:none;font-weight:bold;"><h1>${roadDetail.roadName }</h1></a></p>
                    
                            <div class="content">
                            
                            <p><a style="color:green;text-decoration:none;font-weight:bold;"><h2>基本信息</h2></a></p>
                             <p>价格：${roadDetail.price }</p> 
                              <p>电话：${roadDetail.phone }</p> 
                               <p>集散中心：：${roadDetail.agency }</p> 
                              <p><a style="color:green;text-decoration:none;font-weight:bold;"><h2>概况</h2></a></p>
                               <p>出发地：${roadDetail.goRoad }</p> 
                              <p>返回地：${roadDetail.backRoad }</p> 
                               <p>交通工具：${roadDetail.traffic }</p> 
                                <p>旅游总天数：${roadDetail.days }</p> 
                               <p>类型：${roadDetail.typeName }</p> 
                               <p>标签：${roadDetail.tag }</p> 
                                <p><a style="color:green;text-decoration:none;font-weight:bold;"><h2>行程总描述</h2></a></p>
                                 <p>${roadDetail.mainInfo }</p> 
 ...
 <form name="searchForm" action="roaddetailservlet?op=search" method="post">

	<table class="right-table" width="120%"  border="0px" cellpadding="0" align="center" cellspacing="0">
	
		<tr>
			<td>路线名</td>
			<td><input type="text"  name="roadName" value=""/></td>
		</tr>
			<td>主题</td>
			<td>
				<select name="typeId" id="typeId">
					<option value="-1">--请选择--</option>
						...
						<option value="2" >乡村旅游</option>	
					
						<option value="3" >温泉度假</option>	
					
						<option value="4" >红色旅游</option>	
					
						<option value="5" >美食旅游</option>	
					
						<option value="6" >山岳旅游</option>	
					
						<option value="7" >渔家乐</option>	
					
						<option value="8" >境外游</option>	
		...
		<tr>
			<td>出发地</td>
			<td><input type="text"  name="goRoad" value=""/></td>
		</tr>
		<tr><tr>
			<td>返回地</td>
			<td><input type="text"  name="backRoad" value=""/></td>
		</tr>
		<tr>
		<tr>
			<td>交通工具</td>
			<td><input type="text"  name="traffic" value=""/></td>
		</tr>
		<tr>
		<tr>
			<td>关键字</td>
				...
				<input type="reset" class="general_button" value="清空条件" />
                       ...
                       <!--  <div class="block_sidebar_menu">
                            ...
                            <ul>
								...
								<li><a href="boxes.html">Message Boxes</a></li>
