...
<body>
 ...
 <div class="block_popular_posts">
                        	<h4><a style="text-algin:center;">路线查询</a></h4>
 <form name="searchForm" action="roaddetailservlet?op=search2" method="post">

	<table class="right-table" width="120%"  border="0px" cellpadding="0" align="center" cellspacing="0">
	
		<tr>
			<td>路线名</td>
			<td><input type="text"  name="roadName" value="${requestScope.hotelDetail.roadName }"/></td>
		</tr>
			<td>主题</td>
			<td>
		...
		<tr>
			<td>出发地</td>
			<td><input type="text"  name="goRoad" value="${requestScope.hotelDetail.goRoad }"/></td>
		</tr>
		<tr><tr>
			<td>返回地</td>
			<td><input type="text"  name="backRoad" value="${requestScope.hotelDetail.backRoad }"/></td>
		</tr>
		<tr>
		<tr>
			<td>交通工具</td>
			<td><input type="text"  name="traffic" value="${requestScope.hotelDetail.traffic }"/></td>
		</tr>
		<tr>
		<tr>
			<td>关键字</td>
			<td><input type="text" name="tag" value="${requestScope.hotelDetail.tag }"/></td>
		</tr>
		<tr>
			<td colspan="2">
				...
				<input type="reset" class="general_button" value="清空条件" />
                        ...
                        <c:forEach items="${requestScope.roadDetailList }"  var="roadDetail" varStatus="status">
                            <div class="button_outer first"><div class="button_inner">${roadDetail.roadName }</div><div class="arrow"></div></div><!-- accordeon trigger -->
                            <div class="accordeon_content">
                                <!-- accordeon content goes here -->
                                <p>${roadDetail.mainInfo}</p>
                             <a style="color:#227700;text-decoration:none;" href="roaddetailservlet?op=toRoadDetail&id=${roadDetail.id }" target="_blank">了解更多</a>
                    ...
                    <div class="sidebar">
                     ...
                     <%--    <div class="block_sidebar_menu">
                            ...
                            <ul> 
                              ...
                              <c:forEach items="${requestScope.roadTypeList }"  var="roadType" varStatus="status">
								<li><a href="">${roadType.typeName}</a></li>
							  </c:forEach>
